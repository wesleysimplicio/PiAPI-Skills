# CONTRIBUTING — `PiAPI-Skills`

Guia step-by-step para adicionar uma feature, fix ou refactor em `PiAPI-Skills` (`TBD`, stack `dotnet`). Funciona pra humano e pra agent. Time: `Wesley Simplicio`.
