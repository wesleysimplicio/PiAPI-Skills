...
Entregar a base de autenticação e o pipeline de CI/CD do PiAPI-Skills para destravar todas as features futuras de TBD.
...
3. **Deploy automático em staging** — push em `main` dispara deploy para ambiente `staging.PiAPI-Skills.app` via GitHub Actions.
...
- Domínio `staging.PiAPI-Skills.app` precisa estar provisionado.
